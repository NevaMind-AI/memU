...
class TestCeleryDispatcher:
    ...
    def test_dispatcher_disabled_skips_dispatch(self):
        ...
        result = dispatcher.on_memory_saved({
            'resource_url': 'test.pdf',
            'modality': 'document'
        })
    ...
    def test_on_memory_updated_dispatches_to_celery(self, mock_task):
        ...
        event_data = {
            'resource_url': 'https://example.com/updated.pdf',
            'modality': 'document'
        }
    ...
    def test_on_memory_deleted_logs_event(self):
        ...
        result = dispatcher.on_memory_deleted({
            'memory_id': '123'
        })
    ...
    def test_on_memory_queried_logs_event(self):
        ...
        result = dispatcher.on_memory_queried({
            'query': 'test query'
        })
