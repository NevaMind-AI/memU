...
class ResourceModel(BaseModelMixin, Resource):
    ...
    modality: str = Field(sa_column=Column(String(64), nullable=False))
    local_path: str = Field(sa_column=Column(String(1024), nullable=False))
    ...
    embedding: list[float] | None = Field(default=None, sa_column=Column(Text, nullable=True))
