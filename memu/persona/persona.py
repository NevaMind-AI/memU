...
Provides a clean API for using MemU's Memory functionality with LLM integration.
...
class Persona:
    """MemU core interface providing simple memory and conversation functionality
