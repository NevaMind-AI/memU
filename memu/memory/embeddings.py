...
class EmbeddingClient:
    ...
    def _init_azure(self, **kwargs):
        ...
        try:
            ...
            self.model = kwargs.get('deployment_name') or kwargs.get('model', 'text-embedding-ada-002')
            
            logger.info(f"Azure OpenAI embedding client initialized with deployment: {self.model}")
    ...
    def _embed_custom(self, text: str) -> List[float]:
        ...
        if hasattr(self.client, 'embed'):
            ...
            raise RuntimeError("Custom client does not have a supported embedding method")
