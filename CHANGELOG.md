...
## [3.0.0-beta.0](https://github.com/NevaMind-AI/memU/compare/v2.0.0-beta.0...v3.0.0-beta.0) (2026-09-21)
...
* add developer evolving lifecycle ([#672](https://github.com/NevaMind-AI/memU/issues/672)) ([2b132f0](https://github.com/NevaMind-AI/memU/commit/2b132f07d3295341a3ca06c05f6cc48974d64410))
* **claude-code:** mine cross-platform Cowork sessions ([#639](https://github.com/NevaMind-AI/memU/issues/639)) ([e8ac19e](https://github.com/NevaMind-AI/memU/commit/e8ac19e82842e6b8340130318362daa750ee7986))
* **claude-code:** verify Cowork source composition ([#660](https://github.com/NevaMind-AI/memU/issues/660)) ([42f566a](https://github.com/NevaMind-AI/memU/commit/42f566aeb46e72bfb5b1274b4bcafc922ab89066))
* **cli:** batch developer memorize sessions ([#695](https://github.com/NevaMind-AI/memU/issues/695)) ([08e1ed4](https://github.com/NevaMind-AI/memU/commit/08e1ed4cdf4c0cb1fe5387e4a532ea588a8cbe46))
* **config:** config.env is written by a command, not by the agent (ADR 0017) ([#632](https://github.com/NevaMind-AI/memU/issues/632)) ([6a10507](https://github.com/NevaMind-AI/memU/commit/6a105072bc23582a1a19705a24b7c57a8c078c0a))
...
* **database:** let a backend answer segment recall from its own vector index ([#652](https://github.com/NevaMind-AI/memU/issues/652)) ([edbd422](https://github.com/NevaMind-AI/memU/commit/edbd422fcd925b3ddc57f0c84fbf24e5bb4e51b3))
* define developer conversation input ([#669](https://github.com/NevaMind-AI/memU/issues/669)) ([796a422](https://github.com/NevaMind-AI/memU/commit/796a4221ca29c55937e75d164f12b3973d0374e9))
...
* expose developer memorize CLI ([#686](https://github.com/NevaMind-AI/memU/issues/686)) ([ab2b16c](https://github.com/NevaMind-AI/memU/commit/ab2b16ce20f259d8f56e64e344029b54ba898dc8))
...
* **hosts:** add pi coding agent adapter ([#675](https://github.com/NevaMind-AI/memU/issues/675)) ([37cc4e1](https://github.com/NevaMind-AI/memU/commit/37cc4e161a59fa7280870cd1fb9da28ace3b661d))
...
* materialize developer conversation input ([#670](https://github.com/NevaMind-AI/memU/issues/670)) ([e03c32d](https://github.com/NevaMind-AI/memU/commit/e03c32d90cd740acd79f8db4b43e9873720749b5))
...
* **memu:** update version ([#705](https://github.com/NevaMind-AI/memU/issues/705)) ([2c050bc](https://github.com/NevaMind-AI/memU/commit/2c050bc9681a4c0aff1af211a000e73d14f33356))
...
* **agentic:** embed before writing, batch requests, retry transient failures ([#651](https://github.com/NevaMind-AI/memU/issues/651)) ([57399e5](https://github.com/NevaMind-AI/memU/commit/57399e51540d812fb9345a9e61a18e466d53478c))
* **agentic:** validate RecallFile pagination inputs ([#663](https://github.com/NevaMind-AI/memU/issues/663)) ([abb1148](https://github.com/NevaMind-AI/memU/commit/abb11480e69cec9ca35d954b1c1ffc83ef11c100))
...
* **bridging:** skip empty transcript jobs ([#684](https://github.com/NevaMind-AI/memU/issues/684)) ([db8584c](https://github.com/NevaMind-AI/memU/commit/db8584c28f10798b2dc6b411dc835f911fb1d9bf))
...
* **claude-code:** filter private transcript fields ([#677](https://github.com/NevaMind-AI/memU/issues/677)) ([b61b4bd](https://github.com/NevaMind-AI/memU/commit/b61b4bd08942d6c062f82bfd24d5637c043873a8))
* **cli:** fix developer memorize workspace ([#687](https://github.com/NevaMind-AI/memU/issues/687)) ([ea13504](https://github.com/NevaMind-AI/memU/commit/ea13504014db8f0a7d74b3d41b40977b28810f89))
* **codex:** filter private transcript fields ([#681](https://github.com/NevaMind-AI/memU/issues/681)) ([54f9468](https://github.com/NevaMind-AI/memU/commit/54f94686bf88f02888464c681116a4724a69f070))
...
* **config:** restore Windows portability safeguards ([#655](https://github.com/NevaMind-AI/memU/issues/655)) ([ce37878](https://github.com/NevaMind-AI/memU/commit/ce3787859e2f7c35a00d18723e4763bc6370b8b1))
...
* **hosts:** unify and refresh bridging task registrations ([#641](https://github.com/NevaMind-AI/memU/issues/641)) ([4ea56d5](https://github.com/NevaMind-AI/memU/commit/4ea56d51da4952085e337f1cf4782fdafe632089))
* **hosts:** write instructions atomically ([#643](https://github.com/NevaMind-AI/memU/issues/643)) ([aec07c3](https://github.com/NevaMind-AI/memU/commit/aec07c3bd001e560a9f20e77cbc0cee2f954af36))
* **openclaw:** filter private transcript fields ([#680](https://github.com/NevaMind-AI/memU/issues/680)) ([e5c5cb3](https://github.com/NevaMind-AI/memU/commit/e5c5cb308b4ff838f0cdeb7a527b6a14970ddee5))
...
* **sqlite:** always read the DB in SQLiteResourceRepo.list_resources ([#665](https://github.com/NevaMind-AI/memU/issues/665)) ([8b17fa4](https://github.com/NevaMind-AI/memU/commit/8b17fa4702fce7d5c124df4a4bb96b6dd1681709))
* **vector:** skip empty and wrong-dimension rows in cosine_topk ([#693](https://github.com/NevaMind-AI/memU/issues/693)) ([6e78919](https://github.com/NevaMind-AI/memU/commit/6e78919b60f0abfb1888f87220cb4784ff21b41e))
...
* **retrieve:** scope file roll-up to hit files via id__in ([#694](https://github.com/NevaMind-AI/memU/issues/694)) ([385bdb3](https://github.com/NevaMind-AI/memU/commit/385bdb30cda7f5265368934b8008ce2b73283283))
...
* **hosts:** hide native session storage details ([#659](https://github.com/NevaMind-AI/memU/issues/659)) ([6022f5f](https://github.com/NevaMind-AI/memU/commit/6022f5fce48975b22ba705b54178ae3e8048c157))
